...
<div class="metabox-holder columns-2" id="post-body">
	...
	<div class="stuffbox">
		<h3><label><?php _e('Widgets & Shortcodes', 'TheChamp');?></label></h3>
		<div class="inside">
		<h4>Widgets</h4>
		<p>You can navigate to the <strong>Appearance</strong> > <strong>Widgets</strong> section in the left pan and drag <strong>Super Socializer - Login</strong> and <strong>Super Socializer - Sharing</strong> widgets in the required area.</p>
		
		<h4>Shortcodes</h4>
		<p>You can use <strong>[TheChamp-Login]</strong> and <strong>[TheChamp-Sharing]</strong> Shortcodes in the content of required page/post where you want to display Social Login and Sharing interfaces respectively.</p>
		<p>Optionally, you can use <strong>style</strong> attribute in the Shortcode to style the rendered Social Login and Sharing interfaces.</p>
		<p>For example</p>
